  ...
  */
  ...
  /*
    ...
    Create a variable inside lightSwitch called isTheLightOn and set its initial 
    value to the boolean false. 
  ...
  */
  ...
  /*
    Use the module pattern to create a plant height tracker, name your 
    function 'plantTracker'
    Set up two variables inside plantTracker, 'plant' which should be set 
    to 'fern' and 'height' which should be set to 12
    Return 3 functions using the module pattern
      - 'readInfo' should return a string of 'This is a PLANT plant that is HEIGHT
           inches tall.', where PLANT is the value of the plant variable and HEIGHT 
           is the value of the height variable.
 ...
 function plantTracker(){
    ...
    return {
      readInfo:  function(){
        return `This is a ${asdf.plant} plant that is ${asdf.height} inches tall.`
      },
      
      waterPlant: function(){
        asdf.height = (asdf.height += 1)
        return asdf.height
      },
      prunePlant: function(){
        asdf.height = (asdf.height -= 1)
  ...
  */
  ...
  function inventory(){
    ...
    return{
      ...
      deleteFromProducts: function(input){
        let index = products.indexOf(input) 
